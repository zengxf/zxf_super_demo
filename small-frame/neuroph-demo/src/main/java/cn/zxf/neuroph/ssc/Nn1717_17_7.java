...
import cn.zxf.neuroph.ssc.common.OpenRecordDao;
import cn.zxf.neuroph.ssc.common.ToDoubleArr;
...
public class Nn1717_17_7 implements LearningEventListener {
    ...
    static final int[]                neuronsNumArr    = { 17, 17, 7 };                                                  // 还要加上输出层
    ...
    public static class Row {
        ...
        double[] output() {
            return ToDoubleArr.toDoubleArr( input % 100, 7 );
        }

        double[] input() {
            return ToDoubleArr.toDoubleArr( input, 17 );
        }
    }
