package cn.simple.test.string.encrypt.digest;
...
public class TestSHA_512 {
    ...
    public static void main( String[] args ) throws NoSuchAlgorithmException, IOException {
        ...
        System.out.println( sha ); // SHA-512bit 64B 128Str
        ...
        System.out.println( fileSha ); // File-SHA-512
    }
